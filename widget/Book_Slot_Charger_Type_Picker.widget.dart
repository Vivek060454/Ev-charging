...
class SlotTypePickerWidget extends StatelessWidget {
  final List<Connector> connectors;
  final Function(Connector) onChanged;
  final Connector? value;
  const SlotTypePickerWidget({Key? key, required this.connectors, required this.onChanged, required this.value}) : super(key: key);
  @override
            ...
            child: Column(
              ...
              children: [
                AnimatedContainer(
                  ...
                  /*charger.connectorId == value?.connectorId
                        ? Colors.yellow.withOpacity(.5)
                        : charger.available && charger.compatible
                        ? Colors.green.withOpacity(.5)
                        : !charger.available && charger.compatible
